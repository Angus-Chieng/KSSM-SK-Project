...
<html>
	<body> 
		<center><?php include 'menu.php'; ?> <h2>REKOD MARKAH YANG DICAPAI</h2></center> 
		<main>
		<table width="70%" border="0" align="center" style="font-size:16px">
			...
			$data1=mysqli_query($hubung,"SELECT * FROM perekodan WHERE idpengguna='$idpengguna' 
				...
				//TABLE SOALAN 
				$dataSoalan=mysqli_query($hubung,"SELECT COUNT(idtopik) AS 'bil' FROM soalan WHERE idtopik='$info1[idtopik]'"); 
		...
		<center><font style='font-size:14px'> * Rekod yarig dipaparkan adalah 10 yang terakhir *
