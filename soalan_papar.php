...
//TABLE TOPIK 
$dataTopik = mysqli_query($hubung,"SELECT * FROM soalan AS q INNER JOIN topik AS t ON t.idtopik = q.idtopik 
...
// PILIHAN JAWAPAN 
$query2 = mysqli_query($hubung,"SELECT * FROM pilihan AS c INNER JOIN soalan AS q ON c.idsoalan = q.idsoalan 
...
<html> 
	<body> 
		<center><h2>TOPIK: <?php echo $getSoalan['topik'];?></h2> </center> 
		...
		<tr> 
			...
			<li><input name="choice" type="radio" required value="<?php echo $row['idpilihan']; ?>" />
