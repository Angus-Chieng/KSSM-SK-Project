...
<html> 
	...
	<body> 
	<center><h2>SENARAI SOALAN BAGI TOPIK <?php echo $papartopik; ?></h2> 
	...
	<?php 
		...
		WHERE q.idtopik=$topik_pilihan AND a.jawapan=1 GROUP BY a.idsoalan ORDER BY q.idsoalan ASC");
	...
	<tr>
		...
		<td><a href="edit_soalan.php?idsoalan=<?php echo $info1['idsoalan'];?>"><button>EDIT</button></a>
			<a href="hapus_soalan.php?idsoalan=<?php echo $info1['idsoalan'];?>"><button>HAPUS</button></a> 
		</td> 
	</tr> 
		<?php $no++; } ?> 
	</table> 
