	...
	<body>
		...
		<p> <label>Gambar<br> <?php 
								...
								<input type="file" name="gambar"/> </p> 
									<?php 
									$no=1; 
									$pilihan = mysqli_query($hubung, "SELECT * FROM pilihan AS a 
									INNER JOIN soalan AS q ON q.idsoalan = a.idsoalan 
