...
values('$_SESSION[idpengguna]', '$_SESSION[pilih_topik];','$_SESSION[score]',NULL)";
...
<html> 
	<body> 
		...
		<table width="70%" border="0" align="center"> 
			<tr> 
				<td><p>Tahniah!, Anda telah selesai menjawab semua soalan</p> 
					<p>Bilangan Betul: <?php echo $_SESSION['score']; ?></p> 
				</td>
			</tr> 
			<tr>
				<td><button onclick="window.location.href='soalan_papar.php? n=1'">Cuba Lagi</button> 
