...
<html>
	<body> 
	<center><h2>TOPIK: <?php echo $getTopik['topik'];?></h2> </center> 
	<table width="70%" border="0" align="center"› 
	<tr>
	<td><h2>Arahan kepada pelajar:</h2> 
	<p>Jawab semua soalan. Pilih jawapan yang terbaik.</p> 
	...
	<?php echo $total*0.5; ?> minit <br><br> 
